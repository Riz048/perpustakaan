...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between mb-3">
    <h4 class="font-weight-bold">Data Buku Akademik</h4>

    <!-- BUTTON TAMBAH -->
    @if(Auth::user()->role != 'kepsek')
    <button class="btn btn-primary" data-toggle="modal" data-target="#modalTambahAkad">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-4 mb-2">
              Kode Buku:
              <input type="text" name="kode_buku" class="form-control" placeholder="Contoh: BIO-10" required>
            </div>
            ...
            <div class="col-md-12 mb-2">
               ...
               <div class="mt-2">
                  <img id="addPreview" src="#" alt="Preview" style="max-height:180px; display:none; border:1px solid #ddd; padding:4px; border-radius:4px;">
               </div>
            </div>
...
<div class="modal fade" id="modalEditAkad">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-warning"><h5>Edit Buku Akademik</h5></div>
      ...
      <form id="editAkadForm" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-2">Kode Buku:<input id="eKode" name="kode_buku" class="form-control"></div>
