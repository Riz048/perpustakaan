    ...
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        ...
        <div class="modal-body">
            ...
            <div class="col-md-4 mb-2">Tahun Terbit:<input type="number" name="tahun_terbit" class="form-control" placeholder="YYYY" min="1900" max="2099" required></div>
            <div class="col-md-4 mb-2">Tahun Masuk:<input type="number" name="tahun_masuk" class="form-control" placeholder="YYYY" min="1900" max="2099" required></div>
      ...
      <form id="editNonForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6 mb-2">Tahun Terbit:<input type="number" id="eTahunTerbit" name="tahun_terbit" class="form-control"></div>
