                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input export-section" id="secDipinjam" value="buku_dipinjam" checked>
                                    <label class="custom-control-label" for="secDipinjam">Daftar Buku yang Dipinjam</label>
                                </div>

                                <hr>

                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input export-section" id="secGrafik" value="grafik">
                                    <label class="custom-control-label" for="secGrafik">Sertakan Grafik</label>
                                </div>
